Shader "SFHologram/HologramShader"
{
	...
	{
		// General
		[PerRendererData]_Brightness("Brightness", Range(0.1, 6.0)) = 3.0
		[PerRendererData]_Alpha ("Alpha", Range (0.0, 1.0)) = 1.0
		[PerRendererData]_Direction ("Direction", Vector) = (0,1,0,0)
		// Main Color
		[PerRendererData]_MainTex ("MainTexture", 2D) = "white" {}
		[PerRendererData]_MainColor ("MainColor", Color) = (1,1,1,1)
		// Rim/Fresnel
		[PerRendererData]_RimColor ("Rim Color", Color) = (1,1,1,1)
		[PerRendererData]_RimPower ("Rim Power", Range(0.1, 1)) = .5
		// Scanline
		[PerRendererData]_ScanTiling ("Scan Tiling", Range(0.01, 500.0)) = 0.05
		[PerRendererData]_ScanSpeed ("Scan Speed", Range(-2.0, 2.0)) = 1.0
		// Glow
		[PerRendererData]_GlowTiling ("Glow Tiling", Range(0.01, 3.0)) = 0.05
		[PerRendererData]_GlowSpeed ("Glow Speed", Range(-50.0, 50.0)) = 1.0
		// Glitch
		[PerRendererData]_GlitchSpeed ("Glitch Speed", Range(0, 50)) = 1.0
		[PerRendererData]_GlitchIntensity ("Glitch Intensity", Float) = 0
		// Alpha Flicker
		_FlickerTex ("Flicker Control Texture", 2D) = "white" {}
		[PerRendererData]_FlickerSpeed ("Flicker Speed", Range(0.01, 50)) = 1.0
